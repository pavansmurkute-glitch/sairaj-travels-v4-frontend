...
const fetchContactInfo = async () => {
  try {
    ...
    // Silently handle error and use fallback contact info
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <div className="block sm:hidden">
                <h1 className="text-sm font-bold text-gray-900">SAIRAJ TRAVELS</h1>
                <p className="text-xs text-gray-500 -mt-1">Your Trusted Travel Partner</p>
              </div>
            </div>
            ...
            <div className="lg:hidden border-t border-gray-200 bg-white shadow-lg mobile-menu">
              <div className="px-4 py-3 space-y-1">
                ...
                <Link 
                  to="/booking" 
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="block px-3 py-2 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg text-sm font-semibold text-center transition-all duration-300 hover:from-green-700 hover:to-green-800 mb-2"
                >
                  Book Now
                </Link>
                <Link 
                  to="/trip-planner" 
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="block px-3 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg text-sm font-semibold text-center transition-all duration-300 hover:from-blue-700 hover:to-blue-800"
                >
                  Trip Planner
                </Link>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="border-t border-blue-800 pt-6">
              ...
              <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4">
                ...
                <div className="flex items-center space-x-4 mt-2 md:mt-0">
                  ...
                  {contactInfo?.socialLinkedin && (
                    <a 
                      href={contactInfo.socialLinkedin} 
                      target="_blank" 
                      rel="noopener noreferrer"
            ...
            <div className="text-center mt-4">
              <span className="text-sm text-gray-400">Powered by <span className="text-yellow-400 font-semibold">SanjTiksha Roots & Wings</span></span>
            </div>
          </div>
