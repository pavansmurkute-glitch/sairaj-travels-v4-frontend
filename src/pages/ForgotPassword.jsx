...
const ForgotPassword = () => {
  ...
  const validateToken = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'https://sairaj-travels-v4-backend.onrender.com'}/api/admin/auth/validate-reset-token?token=${token}`);
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'https://sairaj-travels-v4-backend.onrender.com'}/api/admin/auth/forgot-password`, {
        method: 'POST',
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || 'https://sairaj-travels-v4-backend.onrender.com'}/api/admin/auth/reset-password`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
