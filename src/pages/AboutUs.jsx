...
import ownerPhoto from "../assets/Rameshwar.jpg";
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
          ...
          />
                  ...
                  <div className="text-white">
                    <h3 className="text-lg font-bold mb-1">Mr. Rameshwar Ugale</h3>
              ...
              <div className="md:w-3/5 p-6">
                <div className="mb-4">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4 text-sm">
                    ...
                    Mr. Rameshwar Ugale transitioned from defending the country to serving its people through safe and reliable travel. 
                ...
                <div className="bg-gradient-to-r from-green-50 to-blue-50 p-4 rounded-lg border-l-4 border-green-600">
                  ...
                  <div className="mt-2 text-right">
                    <span className="text-green-600 font-semibold text-xs">- Mr. Rameshwar Ugale, Ex-Army Officer</span>
                  </div>
                </div>
              </div>
            </div>
