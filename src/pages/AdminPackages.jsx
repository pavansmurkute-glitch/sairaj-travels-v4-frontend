            ...
            currentPackages.map((pkg) => (
              <div key={pkg.packageId} className="bg-white rounded-lg shadow-md overflow-hidden">
                <img
                  src={(() => {
                    ...
                    if (pkg.packageImageUrl && pkg.packageImageUrl.trim() !== '') {
                      ...
                      return `${IMAGE_BASE_URL}${pkg.packageImageUrl}`;
                    }
                ...
                <div className="p-6">
                  ...
                  {/* Vehicle Information */}
                  {(pkg.vehicleName || pkg.maxPassengers) && (
                    <div className="mb-4 p-2 bg-gray-50 rounded-md">
                      <div className="text-sm text-gray-600">
                        {pkg.vehicleName && (
                          <div className="flex items-center mb-1">
                            <span className="font-medium">Vehicle:</span>
                            <span className="ml-2">{pkg.vehicleName}</span>
                          </div>
                        )}
                        {pkg.maxPassengers && (
                          <div className="flex items-center">
                            <span className="font-medium">Max Passengers:</span>
                            <span className="ml-2">{pkg.maxPassengers}</span>
                          </div>
                        )}
                      </div>
                    </div>
                ...
                <form onSubmit={handleCreatePackage} className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => setFormData({...formData, packageHighlights: e.target.value})}
                      placeholder="e.g., Popular, Best Value, Family Friendly"
                      rows="2"
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => setFormData({...formData, packageFeatures: e.target.value})}
                      placeholder="e.g., Professional Driver, AC Vehicle, On-Time Service, Luggage Assistance, 24/7 Support"
                      rows="2"
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  </div>
              ...
              <div className="mt-3">
                ...
                <form onSubmit={(e) => {
                  ...
                  const updates = {
                    ...
                    maxPassengers: formData.get('maxPassengers') ? parseInt(formData.get('maxPassengers')) : null,
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        name="vehicleId"
                        defaultValue={selectedPackage.vehicleId}
                        className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                      >
                        <option value="">Select a vehicle</option>
                        {vehicles.map((vehicle) => (
                    ...
                    <div>
                      ...
                      <input
                        type="number"
                        name="maxPassengers"
                        defaultValue={selectedPackage.maxPassengers}
                        placeholder="e.g., 7, 12, 18"
                        className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                      />
                    </div>
