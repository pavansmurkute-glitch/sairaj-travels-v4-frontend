...
const images = [
  // Fleet Images
  { id: 1, src: "/images/benzbus1.jpg", category: "Fleet", caption: "Mercedes Benz Luxury Bus", description: "Premium comfort and safety for your journey", featured: true },
  { id: 2, src: "/images/ertiga.avif", category: "Fleet", caption: "Maruti Suzuki Ertiga", description: "Spacious and fuel-efficient family vehicle" },
  { id: 3, src: "/images/innova1.avif", category: "Fleet", caption: "Toyota Innova", description: "Reliable and comfortable for group travel" },
  { id: 4, src: "/images/Kia_carnival.avif", category: "Fleet", caption: "Kia Carnival", description: "Luxury MPV with premium features" },
  { id: 5, src: "/images/urbania1.avif", category: "Fleet", caption: "Force Urbania", description: "Perfect for large group transportation" },
  ...
  // Service Images - Using frontend public folder images
  { id: 13, src: "/images/urbania1.avif", category: "Destinations", caption: "Airport Transfer Service", description: "Reliable airport pickup and drop service" },
  { id: 14, src: "/images/benzbus1.jpg", category: "Fleet", caption: "Bus Transportation", description: "Comfortable bus services for all occasions" },
  { id: 15, src: "/images/Kia_carnival.avif", category: "Happy Customers", caption: "Corporate Travel", description: "Professional corporate transportation" },
  ...
  { id: 17, src: "/images/innova1.avif", category: "Happy Customers", caption: "Family Travel", description: "Safe and comfortable family journeys" },
  { id: 18, src: "/serv_pilgrimage.avif", category: "Destinations", caption: "Pilgrimage Tours", description: "Sacred journey transportation" },
  { id: 19, src: "/images/ertiga.avif", category: "Fleet", caption: "Car Rental Service", description: "Flexible car rental options" },
            ...
            {visibleImages.map((img, idx) => (
              ...
              >
                <div className="relative">
                  {img.imagePath ? (
                    <img
                      src={img.imagePath.startsWith('http') ? img.imagePath : `${IMAGE_BASE_URL}${img.imagePath}`}
                      alt={img.title}
            ...
            <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
              ...
              >
                <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-black">
                  ...
                  {/* Video Overlay Info */}
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-end p-6 pointer-events-none">
                    <div className="text-white">
